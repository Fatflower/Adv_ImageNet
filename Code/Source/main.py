...
trainset = CIFAR10(root=args.data_dir, train=True, download=True, transform = common_train_transfoms(image_size, crop_size, args.mean, args.std))
...
testset = CIFAR10(root=args.data_dir, train=False, download=True, transform = common_test_transfoms(image_size, crop_size, args.mean, args.std))
...
args.logger.info('Data is distributed on signal CPUs : ' + args.gpu)
