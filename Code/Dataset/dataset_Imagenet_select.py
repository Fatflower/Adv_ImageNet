...
# 
# %-----------------------------------------------------------------------------
#  Title   : dataset_Imagenet_select.py
#  Author  : Zhang wentao; 
#  E-mail  : z1282429194@163.com
#  Created : 07/15/2021
#  Description: This part is to load and preprocess Imagenet dataset. 
# 
# %-----------------------------------------------------------------------------
#  Modification History:
#  V1.0: 2021.07.08, first created by Jianfei2333, link:https://github.com/Jianfei2333/torch-utils/tree/main/datasets
#  
# %Header File End--------------------------------------------------------------
...
if __name__ == '__main__':
    # Use cases.
    os.environ["DATAROOT"] = '/home/disk2/hulai/Datasets'
    ...
    subsetdata_speclass = ImageNet(os.environ["DATAROOT"], train=True, subset=[151, 281, 30, 33, 80, 365, 389, 118, 300], max_n_per_class=10)
